      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-base md:text-lg text-[#6a6a6a] leading-relaxed mb-12 max-w-3xl mx-auto">
            Technical product manager with experience across AI products, e-commerce, and 0→1 product development.
            <br /><br />
            I’m a systems thinker who enjoys working close to the technical details behind the product, while caring deeply about thoughtful user experiences.
            <br /><br />
            Currently building <span className="text-[#1a1a1a] font-medium">Innerra</span> — an AI companion for turning everyday thoughts into emotional insight.
          </p>
